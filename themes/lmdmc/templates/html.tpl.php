...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-34702401-17"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-34702401-17');
  </script>
  ...
  <?php if ( isset($_GET['load_nid']) && $_GET['load_nid'] ){ ?>
    <?php
     ...
     ?>
     <meta property="og:site_name" content="Reporta Ciudad">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php print $url; ?>">
    <meta property="og:title" content="<?php print $node->title; ?>">
    <meta property="og:description" content="<?php print $node->body['und'][0]['value'] ?>">
    <meta property="og:image" content="<?php print $imageURL; ?>">
	  <meta name="twitter:card" content="summary">
    <meta name="twitter:url" content="<?php print $url; ?>">
    <meta name="twitter:title" content="<?php print $node->title; ?>">
    <title><?php print $node->title; ?> | Reporta Ciudad</title>
  <?php }else{ ?>
    <title><?php print $head_title; ?></title>
  <?php } ?>
</head>
<body<?php print $body_attributes; ?>>
<div class="overlay-full" style="display: none"></div>
  <?php print $page_top; ?>
  <?php print $page; ?>
